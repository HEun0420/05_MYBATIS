...
public class Application0 {
    ...
    * --> xml에 정의된 태그들을 통해 넓은 방법으로 쓸 수 있음.
    * --> SQL문과 자바 코드가 분리되어있음
     */
    ...
    public static void main(String[] args) {
        ...
        * UnPooledDataSource : ConnectionPool 미사용
        ...
        // 순서 2. configuration 객에체 환경정보 담기
        ...
        /*
        * SsqlSessionFactory : SqlSession 객체를 생성하기 위한 팩토리 역할의 인터페이스
        * SqlSessionFactoryBuilder: SqlSessionFactory 인터페이스 타입의 하위 구현 객체를 생성하기 위한 빌드 역할
        * build() : 설정에 대한 정보를 담고있는 Configuration 타입 객체를 받아 SqlSessionFactory 객체를 반환한느 메소드
         */
        ...
        * - true : Connection 인터페이스 타입 객체로 DML 수행 후 Auto commit에 대한 옵션을 true로 진행
         */
